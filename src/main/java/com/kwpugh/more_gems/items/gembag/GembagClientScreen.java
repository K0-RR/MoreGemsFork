...
public class GembagClientScreen extends HandledScreen<GembagScreenHandler>
{
	   private static final Identifier TEXTURE = new Identifier("textures/gui/container/generic_54.png");
	   private final int rows;

	   public GembagClientScreen(GembagScreenHandler handler, PlayerInventory inventory, Text title)
	   {
